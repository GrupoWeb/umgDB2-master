$(document).ready(function () {
   var tabla = $('#tCapacitacion').DataTable({
        "bDeferRender": true,
        "searching": true,
        "bLengthChange": false,
        ...
        "ajax": {
            "url": "model/tabla/capacitaciones.php",
            "type": "POST"
        },
        "columns": [
     ...
     obtener_data_editar("#tCapacitacion tbody", tabla);
     obtener_data_eliminar("#tCapacitacion tbody", tabla);
});
